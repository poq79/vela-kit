...
/*Bookmarks allow you to remember a specific vela-event and restore subscription at that point of time*/
...
/* Update a bookmark to store the channel and ID of the given vela-event */
